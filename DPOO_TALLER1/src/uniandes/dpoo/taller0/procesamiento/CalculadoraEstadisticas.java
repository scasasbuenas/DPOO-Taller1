...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el país al que pertenece un atleta específico
	 * @param nombreAtleta: Nombre del atleta que se quiere consultar
	 * @return País al que pertence ese atleta
	 */
	public Pais paisAlQueRepresenta(String nombreAtleta)
	{
		Pais resultado = null;
