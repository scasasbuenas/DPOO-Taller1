...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país al cual representa un atleta específico");
		System.out.println("14. Salir de la aplicación\n");
	}


	/**
	 * Le muestra al usuario el nombre del país al cual representa el atleta
	 */
	private void ejecutarPaisAlQueRepresenta()
	{
		System.out.println("\n" + "País al que representa un atleta específico" + "\n");
		String nombreAtleta = input("Por favor ingrese el nombre del atleta");
		Pais resultado = calculadora.paisAlQueRepresenta(nombreAtleta);
		System.out.println(nombreAtleta + " representa" + " a" + resultado.darNombre());
	}
